...
`,
	...
	cmd.Flags().Bool(srvflags.EnableTestbedPrecompile, false, "Enable the testbed precompile; Compatible only with local networks, uncompatible with mainnet and testnet")
