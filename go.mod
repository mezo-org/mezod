...
require (
	...
	cosmossdk.io/simapp v0.0.0-20240715093939-44c5d17ca6d9
...
replace (
	...
	// stick with a version of x/exp compatible with Cosmos SDK v0.47.x
	// TODO: Remove when codebase is migrated to Cosmos SDK v0.50.x
