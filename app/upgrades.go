...
import (
	...
	"github.com/mezo-org/mezod/app/upgrades/v7_0"
	"github.com/mezo-org/mezod/app/upgrades/v8_0"
)

var (
	Upgrades = []upgrades.Upgrade{v0_3.Upgrade, v1_0.UpgradeRC0, v1_0.UpgradeRC1, v2_0.Upgrade, v3_0.Upgrade, v4_0.Upgrade, v5_0.Upgrade, v6_0.Upgrade, v7_0.Upgrade, v8_0.Upgrade}
