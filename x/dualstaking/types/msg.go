...
var (
	...
	_ sdk.Msg = &MsgAutoDelegateTokens{}
)
...
// MsgAutoDelegateTokens implementation

// Route implements the sdk.Msg interface.
func (msg *MsgAutoDelegateTokens) Route() string { return RouterKey }

// Type implements the sdk.Msg interface.
func (msg *MsgAutoDelegateTokens) Type() string { return "AutoDelegateTokens" }

// GetSigners implements the sdk.Msg interface.
func (msg *MsgAutoDelegateTokens) GetSigners() []sdk.AccAddress {
  staker, err := sdk.AccAddressFromBech32(msg.Staker)
  if err != nil {
    panic(err)
  }
...
// GetSignBytes implements the sdk.Msg interface.
func (msg *MsgAutoDelegateTokens) GetSignBytes() []byte {
  bz := ModuleCdc.MustMarshalJSON(msg)
  return sdk.MustSortJSON(bz)
}

// ValidateBasic implements the sdk.Msg interface.
func (msg *MsgAutoDelegateTokens) ValidateBasic() error {
  if msg.Staker == "" {
    return errorsmod.Wrap(sdkerrors.ErrInvalidAddress, "staker address cannot be empty")
  }
  if !msg.Amount.IsValid() {
