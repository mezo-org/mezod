...
type GenesisState struct {
	...
	// bridge_out_paused indicates whether bridging out is paused.
	BridgeOutPaused bool `protobuf:"varint,26,opt,name=bridge_out_paused,json=bridgeOutPaused,proto3" json:"bridge_out_paused,omitempty"`
	// bridge_in_paused indicates whether bridging in is paused.
	BridgeInPaused bool `protobuf:"varint,27,opt,name=bridge_in_paused,json=bridgeInPaused,proto3" json:"bridge_in_paused,omitempty"`
	// bridge_out_chains is the list of target chains that accept bridge-outs.
	// Each entry must fit in a uint8. A chain outside the list is disabled.
	BridgeOutChains []uint32 `protobuf:"varint,28,rep,packed,name=bridge_out_chains,json=bridgeOutChains,proto3" json:"bridge_out_chains,omitempty"`
}
...
func (m *GenesisState) GetBridgeOutPaused() bool {
	if m != nil {
		return m.BridgeOutPaused
	}
	return false
}

func (m *GenesisState) GetBridgeInPaused() bool {
	if m != nil {
		return m.BridgeInPaused
	}
	return false
}

func (m *GenesisState) GetBridgeOutChains() []uint32 {
	if m != nil {
		return m.BridgeOutChains
	}
	return nil
}
...
var fileDescriptor_c6a9d1c622979efc = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BridgeOutChains) > 0 {
		dAtA2 := make([]byte, len(m.BridgeOutChains)*10)
		var j1 int
		for _, num := range m.BridgeOutChains {
			for num >= 1<<7 {
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.BridgeOutChains) > 0 {
		l = 0
		for _, e := range m.BridgeOutChains {
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BridgeOutPaused", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BridgeOutPaused = bool(v != 0)
		case 27:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BridgeInPaused", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 28:
			if wireType == 0 {
				...
				m.BridgeOutChains = append(m.BridgeOutChains, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.BridgeOutChains) == 0 {
					m.BridgeOutChains = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field BridgeOutChains", wireType)
			}
		default:
			iNdEx = preIndex
