...
// AssetUnlockedEvent represents the event where inbound assets are released
// from the bridge.
...
func (m *AssetUnlockedEvent) Reset()         { *m = AssetUnlockedEvent{} }
func (m *AssetUnlockedEvent) String() string { return proto.CompactTextString(m) }
func (*AssetUnlockedEvent) ProtoMessage()    {}
func (*AssetUnlockedEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_7905948c23f4425c, []int{2}
}
func (m *AssetUnlockedEvent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AssetUnlockedEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AssetUnlockedEvent.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AssetUnlockedEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AssetUnlockedEvent.Merge(m, src)
}
func (m *AssetUnlockedEvent) XXX_Size() int {
	return m.Size()
}
func (m *AssetUnlockedEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_AssetUnlockedEvent.DiscardUnknown(m)
}

var xxx_messageInfo_AssetUnlockedEvent proto.InternalMessageInfo

func (m *AssetUnlockedEvent) GetRecipient() []byte {
	if m != nil {
		return m.Recipient
	}
	return nil
...
func (m *AssetUnlockedEvent) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
func (m *AssetUnlockedEvent) GetChain() uint32 {
	if m != nil {
		return m.Chain
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*AssetUnlockedEvent)(nil), "mezo.bridge.v1.AssetUnlockedEvent")
...
var fileDescriptor_7905948c23f4425c = []byte{
	...
	,
}
...
func (m *AssetUnlockedEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AssetUnlockedEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AssetUnlockedEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AssetUnlockedEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AssetUnlockedEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AssetUnlockedEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AssetUnlockedEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
