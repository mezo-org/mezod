...
type Params struct {
	...
	MaxErc20Tokens uint32 `protobuf:"varint,1,opt,name=max_erc20_tokens,json=maxErc20Tokens,proto3" json:"max_erc20_tokens,omitempty"`
}
...
func (m *Params) GetMaxErc20Tokens() uint32 {
	if m != nil {
		return m.MaxErc20Tokens
	}
	return 0
}
...
var fileDescriptor_7905948c23f4425c = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MaxErc20Tokens != 0 {
		i = encodeVarintBridge(dAtA, i, uint64(m.MaxErc20Tokens))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Params) Size() (n int) {
	...
	_ = l
	if m.MaxErc20Tokens != 0 {
		n += 1 + sovBridge(uint64(m.MaxErc20Tokens))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxErc20Tokens", wireType)
			}
			m.MaxErc20Tokens = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxErc20Tokens |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
