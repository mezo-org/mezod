...
var (
	...
	pattern_Query_Validator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"evmos", "poa", "v1", "validators", "operator"}, "", runtime.AssumeColonVerbOpt(false)))
