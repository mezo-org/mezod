...
type EthCallRequest struct {
	...
	// (optional).
	StateOverride []byte `protobuf:"bytes,5,opt,name=state_override,json=stateOverride,proto3" json:"state_override,omitempty"`
}
...
func (m *EthCallRequest) GetStateOverride() []byte {
	if m != nil {
...
// SimulateV1Request defines the SimulateV1 request. `opts` is the
// JSON-serialized spec-shaped SimOpts (same marshaling pattern as
// EthCallRequest.Args so the proto is stable against spec evolution).
type SimulateV1Request struct {
	// opts is the JSON-encoded simOpts payload.
	Opts []byte `protobuf:"bytes,1,opt,name=opts,proto3" json:"opts,omitempty"`
	// block_number_or_hash is the ancestor block the simulation starts from
	// ("latest", "0x..." or a 0x-prefixed hash), serialized as JSON to match
	// geth's rpc.BlockNumberOrHash wire shape.
	BlockNumberOrHash []byte `protobuf:"bytes,2,opt,name=block_number_or_hash,json=blockNumberOrHash,proto3" json:"block_number_or_hash,omitempty"`
	// gas_cap defines the per-request gas cap (reused from the shared eth_call
	// knob).
...
func (m *SimulateV1Request) GetOpts() []byte {
	if m != nil {
		return m.Opts
	}
	return nil
...
func (m *SimulateV1Request) GetBlockNumberOrHash() []byte {
	if m != nil {
		return m.BlockNumberOrHash
	}
	return nil
}
...
func (m *SimulateV1Request) GetTimeoutMs() int64 {
	if m != nil {
		return m.TimeoutMs
	}
	return 0
...
// failures ride on the dedicated `error` message rather than as a
// gRPC status so Go error identity survives the wire boundary
// (status.Error collapses type information).
type SimulateV1Response struct {
	// result is the JSON-encoded []*SimBlockResult payload. Populated only on
	// successful runs; empty when error is set.
	Result []byte `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"`
	// error carries a spec-reserved JSON-RPC code + message + optional
	// data payload when the request hit a structured failure
	// (state-override validation, sanitize-chain, unsupported-EIP
	// override, preflight). Nil on success.
	Error *SimError `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}
...
func (m *SimulateV1Response) GetError() *SimError {
	if m != nil {
		return m.Error
	}
	return nil
...
func (m *SimError) String() string { return proto.CompactTextString(m) }
func (*SimError) ProtoMessage()    {}
func (*SimError) Descriptor() ([]byte, []int) {
	return fileDescriptor_e15a877459347994, []int{26}
}
func (m *SimError) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SimError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SimError.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SimError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SimError.Merge(m, src)
}
func (m *SimError) XXX_Size() int {
	return m.Size()
}
func (m *SimError) XXX_DiscardUnknown() {
	xxx_messageInfo_SimError.DiscardUnknown(m)
}

var xxx_messageInfo_SimError proto.InternalMessageInfo

func (m *SimError) GetCode() int32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *SimError) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func (m *SimError) GetData() string {
	if m != nil {
		return m.Data
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*SimError)(nil), "ethermint.evm.v1.SimError")
}
...
var fileDescriptor_e15a877459347994 = []byte{
	...
	,
}
...
func (m *SimulateV1Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BlockNumberOrHash) > 0 {
		i -= len(m.BlockNumberOrHash)
		copy(dAtA[i:], m.BlockNumberOrHash)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.BlockNumberOrHash)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Opts) > 0 {
		i -= len(m.Opts)
		copy(dAtA[i:], m.Opts)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.Opts)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SimError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SimError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SimError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SimulateV1Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Opts = append(m.Opts[:0], dAtA[iNdEx:postIndex]...)
			if m.Opts == nil {
				m.Opts = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockNumberOrHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BlockNumberOrHash = append(m.BlockNumberOrHash[:0], dAtA[iNdEx:postIndex]...)
			if m.BlockNumberOrHash == nil {
				m.BlockNumberOrHash = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
...
func (m *SimError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SimError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SimError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
