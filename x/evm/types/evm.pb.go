...
type Params struct {
	...
	// storage_root_strategy defines the strategy for the EVM storage root
	// mechanism.
	StorageRootStrategy uint32 `protobuf:"varint,7,opt,name=storage_root_strategy,json=storageRootStrategy,proto3" json:"storage_root_strategy,omitempty"`
	// precompiles_versions defines the versions of the custom EVM precompiles.
	PrecompilesVersions []*PrecompileVersionInfo `protobuf:"bytes,8,rep,name=precompiles_versions,json=precompilesVersions,proto3" json:"precompiles_versions,omitempty"`
	...
	// tx_lockdown_enabled indicates whether the transaction lockdown is active.
	// While active, only transactions that pass the lockdown rule are accepted.
	TxLockdownEnabled bool `protobuf:"varint,12,opt,name=tx_lockdown_enabled,json=txLockdownEnabled,proto3" json:"tx_lockdown_enabled,omitempty"`
	// tx_lockdown_senders is the list of extra allowed sender addresses
	// (as hex-encoded EVM addresses) evaluated while the transaction lockdown
	// is active. An empty list matches every sender unless tx_lockdown_targets
	// is empty too.
	TxLockdownSenders []string `protobuf:"bytes,13,rep,name=tx_lockdown_senders,json=txLockdownSenders,proto3" json:"tx_lockdown_senders,omitempty"`
	// tx_lockdown_targets is the list of extra allowed target addresses
	// (as hex-encoded EVM addresses) evaluated while the transaction lockdown
	// is active. An empty list matches every target unless tx_lockdown_senders
	// is empty too.
	TxLockdownTargets []string `protobuf:"bytes,14,rep,name=tx_lockdown_targets,json=txLockdownTargets,proto3" json:"tx_lockdown_targets,omitempty"`
}
...
func (m *Params) GetStorageRootStrategy() uint32 {
	if m != nil {
		return m.StorageRootStrategy
	}
	return 0
}

func (m *Params) GetPrecompilesVersions() []*PrecompileVersionInfo {
	if m != nil {
		return m.PrecompilesVersions
	}
	return nil
}

func (m *Params) GetMaxPrecompilesCallsPerExecution() uint32 {
	if m != nil {
		return m.MaxPrecompilesCallsPerExecution
	}
	return 0
}

func (m *Params) GetChainFeeSplitterAddress() string {
	if m != nil {
		return m.ChainFeeSplitterAddress
	}
	return ""
}

func (m *Params) GetMezoMinterAddress() string {
	if m != nil {
		return m.MezoMinterAddress
	}
	return ""
}

func (m *Params) GetTxLockdownEnabled() bool {
	if m != nil {
		return m.TxLockdownEnabled
	}
	return false
}

func (m *Params) GetTxLockdownSenders() []string {
	if m != nil {
		return m.TxLockdownSenders
	}
	return nil
}

func (m *Params) GetTxLockdownTargets() []string {
	if m != nil {
		return m.TxLockdownTargets
	}
	return nil
}

// PrecompileVersionInfo defines the version of a custom EVM precompile.
type PrecompileVersionInfo struct {
	// precompile_address represents the EVM address of the precompile.
	PrecompileAddress string `protobuf:"bytes,1,opt,name=precompile_address,json=precompileAddress,proto3" json:"precompile_address,omitempty"`
	// version represents the version of the precompile.
	Version uint32 `protobuf:"varint,2,opt,name=version,proto3" json:"version,omitempty"`
}

func (m *PrecompileVersionInfo) Reset()         { *m = PrecompileVersionInfo{} }
func (m *PrecompileVersionInfo) String() string { return proto.CompactTextString(m) }
func (*PrecompileVersionInfo) ProtoMessage()    {}
func (*PrecompileVersionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_d21ecc92c8c8583e, []int{1}
}
func (m *PrecompileVersionInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PrecompileVersionInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PrecompileVersionInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PrecompileVersionInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrecompileVersionInfo.Merge(m, src)
}
func (m *PrecompileVersionInfo) XXX_Size() int {
	return m.Size()
}
func (m *PrecompileVersionInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_PrecompileVersionInfo.DiscardUnknown(m)
}

var xxx_messageInfo_PrecompileVersionInfo proto.InternalMessageInfo

func (m *PrecompileVersionInfo) GetPrecompileAddress() string {
	if m != nil {
		return m.PrecompileAddress
	}
	return ""
}

func (m *PrecompileVersionInfo) GetVersion() uint32 {
	if m != nil {
		return m.Version
	}
	return 0
...
type ChainConfig struct {
	...
	// osaka_time switch block (nil = no fork, 0 = already on osaka)
	...
	// bpo1_time switch block (nil = no fork, 0 = already on bpo1)
	BPO1Time *cosmossdk_io_math.Int `protobuf:"bytes,26,opt,name=bpo1_time,json=bpo1Time,proto3,customtype=cosmossdk.io/math.Int" json:"bpo1_time,omitempty" yaml:"bpo1_time"`
	// bpo2_time switch block (nil = no fork, 0 = already on bpo2)
	BPO2Time *cosmossdk_io_math.Int `protobuf:"bytes,27,opt,name=bpo2_time,json=bpo2Time,proto3,customtype=cosmossdk.io/math.Int" json:"bpo2_time,omitempty" yaml:"bpo2_time"`
	// bpo3_time switch block (nil = no fork, 0 = already on bpo3)
	BPO3Time *cosmossdk_io_math.Int `protobuf:"bytes,28,opt,name=bpo3_time,json=bpo3Time,proto3,customtype=cosmossdk.io/math.Int" json:"bpo3_time,omitempty" yaml:"bpo3_time"`
	// bpo4_time switch block (nil = no fork, 0 = already on bpo4)
	BPO4Time *cosmossdk_io_math.Int `protobuf:"bytes,29,opt,name=bpo4_time,json=bpo4Time,proto3,customtype=cosmossdk.io/math.Int" json:"bpo4_time,omitempty" yaml:"bpo4_time"`
	// bpo5_time switch block (nil = no fork, 0 = already on bpo5)
	BPO5Time *cosmossdk_io_math.Int `protobuf:"bytes,30,opt,name=bpo5_time,json=bpo5Time,proto3,customtype=cosmossdk.io/math.Int" json:"bpo5_time,omitempty" yaml:"bpo5_time"`
	// amsterdam_time switch block (nil = no fork, 0 = already on amsterdam)
	AmsterdamTime *cosmossdk_io_math.Int `protobuf:"bytes,31,opt,name=amsterdam_time,json=amsterdamTime,proto3,customtype=cosmossdk.io/math.Int" json:"amsterdam_time,omitempty" yaml:"amsterdam_time"`
	// verkle_time switch block (nil = no fork, 0 = already on verkle)
	VerkleTime *cosmossdk_io_math.Int `protobuf:"bytes,32,opt,name=verkle_time,json=verkleTime,proto3,customtype=cosmossdk.io/math.Int" json:"verkle_time,omitempty" yaml:"verkle_time"`
}
...
func init() {
	...
	proto.RegisterType((*PrecompileVersionInfo)(nil), "ethermint.evm.v1.PrecompileVersionInfo")
...
var fileDescriptor_d21ecc92c8c8583e = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TxLockdownTargets) > 0 {
		for iNdEx := len(m.TxLockdownTargets) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TxLockdownTargets[iNdEx])
			copy(dAtA[i:], m.TxLockdownTargets[iNdEx])
			i = encodeVarintEvm(dAtA, i, uint64(len(m.TxLockdownTargets[iNdEx])))
			i--
			dAtA[i] = 0x72
		}
	}
	if len(m.TxLockdownSenders) > 0 {
		for iNdEx := len(m.TxLockdownSenders) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TxLockdownSenders[iNdEx])
			copy(dAtA[i:], m.TxLockdownSenders[iNdEx])
			i = encodeVarintEvm(dAtA, i, uint64(len(m.TxLockdownSenders[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
	if m.TxLockdownEnabled {
		i--
		if m.TxLockdownEnabled {
			dAtA[i] = 1
		} else {
	...
	if len(m.MezoMinterAddress) > 0 {
		i -= len(m.MezoMinterAddress)
		copy(dAtA[i:], m.MezoMinterAddress)
		i = encodeVarintEvm(dAtA, i, uint64(len(m.MezoMinterAddress)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.ChainFeeSplitterAddress) > 0 {
		i -= len(m.ChainFeeSplitterAddress)
		copy(dAtA[i:], m.ChainFeeSplitterAddress)
		i = encodeVarintEvm(dAtA, i, uint64(len(m.ChainFeeSplitterAddress)))
		i--
		dAtA[i] = 0x52
	}
	if m.MaxPrecompilesCallsPerExecution != 0 {
		i = encodeVarintEvm(dAtA, i, uint64(m.MaxPrecompilesCallsPerExecution))
		i--
		dAtA[i] = 0x48
	}
	if len(m.PrecompilesVersions) > 0 {
		for iNdEx := len(m.PrecompilesVersions) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PrecompilesVersions[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.StorageRootStrategy != 0 {
		i = encodeVarintEvm(dAtA, i, uint64(m.StorageRootStrategy))
		i--
		dAtA[i] = 0x38
	}
...
func (m *PrecompileVersionInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PrecompileVersionInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PrecompileVersionInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Version != 0 {
		i = encodeVarintEvm(dAtA, i, uint64(m.Version))
		i--
		dAtA[i] = 0x10
	}
	if len(m.PrecompileAddress) > 0 {
		i -= len(m.PrecompileAddress)
		copy(dAtA[i:], m.PrecompileAddress)
		i = encodeVarintEvm(dAtA, i, uint64(len(m.PrecompileAddress)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ChainConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AmsterdamTime != nil {
		{
			size := m.AmsterdamTime.Size()
			i -= size
			if _, err := m.AmsterdamTime.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintEvm(dAtA, i, uint64(size))
		}
	...
	if m.BPO5Time != nil {
		{
			size := m.BPO5Time.Size()
			i -= size
			if _, err := m.BPO5Time.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintEvm(dAtA, i, uint64(size))
		}
	...
	if m.BPO4Time != nil {
		{
			size := m.BPO4Time.Size()
			i -= size
			if _, err := m.BPO4Time.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintEvm(dAtA, i, uint64(size))
		}
	...
	if m.BPO3Time != nil {
		{
			size := m.BPO3Time.Size()
			i -= size
			if _, err := m.BPO3Time.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintEvm(dAtA, i, uint64(size))
		}
	...
	if m.BPO2Time != nil {
		{
			size := m.BPO2Time.Size()
			i -= size
			if _, err := m.BPO2Time.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintEvm(dAtA, i, uint64(size))
		}
	...
	if m.BPO1Time != nil {
		{
			size := m.BPO1Time.Size()
			i -= size
			if _, err := m.BPO1Time.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintEvm(dAtA, i, uint64(size))
		}
...
func (m *Params) Size() (n int) {
	...
	if m.StorageRootStrategy != 0 {
		n += 1 + sovEvm(uint64(m.StorageRootStrategy))
	}
	if len(m.PrecompilesVersions) > 0 {
		for _, e := range m.PrecompilesVersions {
			l = e.Size()
			n += 1 + l + sovEvm(uint64(l))
		}
	}
	if m.MaxPrecompilesCallsPerExecution != 0 {
		n += 1 + sovEvm(uint64(m.MaxPrecompilesCallsPerExecution))
	}
	l = len(m.ChainFeeSplitterAddress)
	if l > 0 {
		n += 1 + l + sovEvm(uint64(l))
	}
	l = len(m.MezoMinterAddress)
	if l > 0 {
		n += 1 + l + sovEvm(uint64(l))
	}
	if m.TxLockdownEnabled {
	...
	if len(m.TxLockdownSenders) > 0 {
		for _, s := range m.TxLockdownSenders {
			l = len(s)
			n += 1 + l + sovEvm(uint64(l))
		}
	}
	if len(m.TxLockdownTargets) > 0 {
		for _, s := range m.TxLockdownTargets {
			l = len(s)
			n += 1 + l + sovEvm(uint64(l))
		}
	}
...
func (m *PrecompileVersionInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.PrecompileAddress)
	if l > 0 {
		n += 1 + l + sovEvm(uint64(l))
	}
	if m.Version != 0 {
		n += 1 + sovEvm(uint64(m.Version))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StorageRootStrategy", wireType)
			}
			m.StorageRootStrategy = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowEvm
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StorageRootStrategy |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrecompilesVersions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrecompilesVersions = append(m.PrecompilesVersions, &PrecompileVersionInfo{})
			if err := m.PrecompilesVersions[len(m.PrecompilesVersions)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxPrecompilesCallsPerExecution", wireType)
			}
			m.MaxPrecompilesCallsPerExecution = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowEvm
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxPrecompilesCallsPerExecution |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChainFeeSplitterAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ChainFeeSplitterAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MezoMinterAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MezoMinterAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxLockdownEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TxLockdownEnabled = bool(v != 0)
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxLockdownSenders", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TxLockdownSenders = append(m.TxLockdownSenders, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxLockdownTargets", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TxLockdownTargets = append(m.TxLockdownTargets, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *PrecompileVersionInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PrecompileVersionInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PrecompileVersionInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrecompileAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrecompileAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
...
func (m *ChainConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BPO1Time", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v cosmossdk_io_math.Int
			m.BPO1Time = &v
			if err := m.BPO1Time.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BPO2Time", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v cosmossdk_io_math.Int
			m.BPO2Time = &v
			if err := m.BPO2Time.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 28:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BPO3Time", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v cosmossdk_io_math.Int
			m.BPO3Time = &v
			if err := m.BPO3Time.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BPO4Time", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v cosmossdk_io_math.Int
			m.BPO4Time = &v
			if err := m.BPO4Time.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 30:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BPO5Time", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v cosmossdk_io_math.Int
			m.BPO5Time = &v
			if err := m.BPO5Time.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 31:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AmsterdamTime", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v cosmossdk_io_math.Int
			m.AmsterdamTime = &v
			if err := m.AmsterdamTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 32:
