...
wget -O ~/.mezod/config/adrbook.json https://snapshot.notional.ventures/mezo/addrbook.json
...
export MEZOD_P2P_MAX_NUM_INBOUND_PEERS=200
export MEZOD_P2P_MAX_NUM_OUTBOUND_PEERS=200
export MEZOD_STATESYNC_RPC_SERVERS="https://mezo-rpc.polkachu.com:443,https://rpc-mezo-ia.notional.ventures:443"
