...
type CosmosTxArgs struct {
	...
	// ChainID is the chain's id on cosmos format, e.g. 'mezo_31611-1'
	ChainID string
...
func PrepareCosmosTx(
	...
	if args.GasPrice != nil {
		fees = sdk.Coins{{Denom: utils.BaseDenom, Amount: args.GasPrice.MulRaw(int64(args.Gas))}} //nolint:gosec
	} else {
